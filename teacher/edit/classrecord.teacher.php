...
input::-webkit-inner-spin-button {
    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-light" id="exampleModalLabel">Edit Lecture Class Record</h5>
            </div>
            <!-- end of modal header -->
                <!-- modal body -->
                <div class="modal-body">
                    ...
                    <div class="table-responsive">
                        <table class="table" >
                            ...
                            $stid = $_GET['stid']; 
                            $c = 1;
                            $sql2 = "SELECT * from student_cs where subject_code = '$subcode' and student_id = '$stid' and teacher_id = '$id' and term = '$term' and course = '$course'";
                            $result2 = $conn->query($sql2);
                    ...
                    <?php echo  "<a class='btn btn-sm btn-outline-secondary' href='../records/csrecord.teacher.php?stid=&sub=$sub&course=$course&year=$year'>Cancel</a>"; ?>
                    </div>
                    <!-- end of modal footer -->
        </div>
    </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <!-- end of modal header -->
            <form class="needs-validation" novalidate action="../../database/changescore/cs.db.php" method="post">
                <!-- modal body -->
                <div class="modal-body">
                    <!-- text box student id -->

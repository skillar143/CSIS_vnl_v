...
input::-webkit-inner-spin-button {
                ...
                <div class="modal-body">
                    ...
                    <div class="table-responsive">
                        <table class="table" >
                            ...
                            $stid = $_GET['stid']; 
                            $c = 1;
                            $sql2 = "SELECT * from student_exam where subject_code = '$subcode' and student_id = '$stid' and teacher_id = '$id' and term = '$term' and course = '$course'";
                            $result2 = $conn->query($sql2);
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <!-- end of modal header -->
            <form class="needs-validation" novalidate action="../../database/changescore/exam.db.php" method="post">
                <!-- modal body -->
                <div class="modal-body">
                    <!-- text box student id -->

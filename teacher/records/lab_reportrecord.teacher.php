...
<div class="float-right m-1">
    <a class="btn btn-sm btn-outline-primary" data-toggle="modal" data-target="#Labreport"><i class="fas fa-plus"></i> Laboratory Reporting</a>
</div>
<p><?php echo $course ?></p>

<?php 
   $current = "lab";
   $lab = "lab_reportrecord.teacher.php";
   $lec = "reportrecord.teacher.php";
...
<table class="table table-bordered text-center" id="datatableid">
    ...
    <tr>
                ...
                <tr>
                    <?php
                $sql = "SELECT * from teacher_laboratory_reporting where teacher_id = '$tid' and term = '$term' and subject_code = '$subcode'";
...
<div class="modal fade" id="Labreport" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <!-- modal header -->
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-light" id="exampleModalLabel">Laboratory Reporting</h5>
                <button class="close text-light btn btn-sm" type="button" data-dismiss="modal" aria-label="Close">
                    <i class="fa fa-window-close" aria-hidden="true"></i>
                </button>
            </div>
            <!-- end of modal header -->
            <form class="needs-validation" action="../../database/grade/laboratory_reporting.db.php" method="post" novalidate>
                <!-- modal body -->

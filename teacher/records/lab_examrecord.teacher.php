...
<div class="float-right m-1">
    <a class="btn btn-sm btn-outline-primary" data-toggle="modal" data-target="#LabExam"><i class="fas fa-plus"></i> Laboratory Exam</a>
</div>
<p><?php echo $course ?></p>

<?php 
   $current = "lab";
   $lab = "lab_examrecord.teacher.php";
   $lec = "examrecord.teacher.php";
...
<table class="table table-bordered text-center" id="datatableid">
    ...
    <tr>
            ...
            <tr> 
                    <?php
                $sql = "SELECT * from teacher_laboratory_exam where teacher_id = '$uid' and term = '$term' and subject_code = '$subcode'";
...
?>
        <tr>
            ...
            <?php
                ...
                $edit = "<a class='btn btn-sm btn-outline-info' href='../edit/lab_examrecord.teacher.php?stid=$row[student_id]&sub=$sub&course=$course&year=$year'>
...
<div class="modal fade" id="LabExam" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <!-- modal header -->
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-light" id="exampleModalLabel">Laboratory Exam</h5>
                <button class="close text-light btn btn-sm" type="button" data-dismiss="modal" aria-label="Close">
                    <i class="fa fa-window-close" aria-hidden="true"></i>
                </button>
            </div>
            <!-- end of modal header -->
            <form class="needs-validation" action="../../database/grade/laboratory_exam.db.php" method="post" novalidate>
                <!-- modal body -->

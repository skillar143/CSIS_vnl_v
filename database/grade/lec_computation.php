        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                if ($result2->num_rows > 0) {
                    ...
                    $csarray[] = number_format(($scs / $tcs * 50 + 50)* .25, 0); 
        ...
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                ...
                if ($result2->num_rows > 0) {
                    ...
                    $examarray[] = number_format(($scs / $tex * 50 + 50)* .40, 0); 
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        if ($result2->num_rows > 0) {
            while ($row2 = $result2->fetch_assoc()) { 
                ...
                $score = $row2['score']; 
                $srep = $srep + $score;
                $reportarray[] = number_format(($srep / $trep * 50 + 50)* .25, 0); 
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                if ($result2->num_rows > 0) {
                    while ($row2 = $result2->fetch_assoc()) {    
                        $score = $row2['score']; 
                        $sat = $sat + $score;
                        $satarray[] = number_format($sat * .10, 0); 
                    }
                }

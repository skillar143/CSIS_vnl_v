    ...
    <div class="p-5">
        ...
        <?php
            ...
            ?>
                ...
                <br>
                <a class="btn btn-danger" id="print-btn" href="../teacher/records/gradingsheet.teacher.php?sub=<?php echo $sub;?>&course=<?php echo $course;?>&level=<?php echo $year;?>"><i class="fas fa-arrow-circle-left"></i></a>

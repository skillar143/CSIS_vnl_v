...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
                ...
                <div id="collapsestudentlist" class="collapse" aria-labelledby="headingstudentlist" data-parent="#accordionSidebar">
            ...
            <li class="nav-item">
                <button class="nav-link collapsed btn btn" disabled="disabled" id="gradingBtn" href="#" data-toggle="collapse" data-target="#collapseinputgrade"
                    aria-expanded="true" aria-controls="collapseTwo">
                    <i class="fas fa-chart-line"></i>
                    <span>Input Grade</span>
                </button>
                <div id="collapseinputgrade" class="collapse" aria-labelledby="headinginputgrade" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Subjects:</h6>
                        <?php
                    include_once '../database/dbconnection.db.php';

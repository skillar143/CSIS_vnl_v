<div class="p-2 m-3">
    <h5 class="text-center bg-primary text-light">4th Year</h5>
    <div>
        <h5>1st Semester</h5>
        ...
        $prod = "SELECT * from programs where year = 'forth' and sem = 'first' and course = '$course'";
...
<div class="p-2 m-3">
    <div>
        ...
        $prod = "SELECT * from programs where year = 'forth' and sem = 'second' and course = '$course'";
        $result = $conn->query($prod);
        if ($result->num_rows > 0) {
            while ($row = $result->fetch_assoc()) {
                $subject = $row['subject'];
